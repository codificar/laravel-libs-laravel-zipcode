...
// to run test: sail artisan test --filter LibZipcodeLanguageSpanishTest
class LibZipcodeLanguageSpanishTest extends TestCase
{
    /**
    ...
    // Caminhos para os arquivos de array em diferentes diretórios
	{
        ...
        $path = base_path() . '/vendor/codificar/zipcode/src/resources/lang';
